...
const allMembers = [
  [
    "Abbie Tran",
    "UMD Website Team (PM)",
    "UMD Chapter Co-Founder",
    "abbietran.jpg",
  ],
  ["Lydia Hu", "WISE-E Team (PM)", "UMD Chapter Co-Founder", "lydiahu.png"],
  [
    "Simin Li",
    "ECODistricts Team (PM)",
    "UMD Chapter Co-Founder",
    "siminli.PNG",
  ],
  [
    "Anna Feng",
    "CaDC Water Rebates Team (Tech Lead)",
    "Software Engineer",
    "AnnaFeng.png",
  ],
  ...
  [
    "Alexis Johnson",
    "CaDC Data Parser Team",
    "UI/UX Designer",
    "AlexisJohnson.jpg",
  ],
  ["Rae Wu", "CaDC Data Parser Team", "Software Engineer", "RachelWu.jpg"],
  [
    "Ferzam Mohammad",
    "Inspire and Empower Team (PM)",
    "Software Engineer",
    "MohammadFerzam.jpeg",
  ],
  [
    ...
    "Arcadia Team (PM)",
    "Software Engineer",
    "SadenaRishindran.jpg",
  ],
  [
    "Mohini Dutta",
    "CaDC Data Parser Team (PM)",
    "Software Engineer",
    "MohiniDutta.jpg",
  ],
  [
  ...
  [
    "Daneil Nguyen",
    "CaDC Water Rebates Team (PM)",
    "Software Engineer",
    "daneilnguyen.jpg",
  ],
  [
    "Vrundal Shah",
    "Inspire and Empower (Tech Lead)",
    "Software Engineer",
    "VrundalShah.jpg",
  ],
  [
    "Stanley Thomas",
    "CaDC Data Parser Team (Tech Lead)",
    "Software Engineer",
    "Stanley.jpg",
  ],
  ...
  [
    ...
    "CaDC Water Rebates Team",
    "Software Engineer",
    "SurabiRamamurthy.jpg",
  ],

  [
    "Daniel Wei",
    "Inspire and Empower Team",
    "Software Engineer",
    "DanielWei.jpg",
  ],
  ...
  [
    "Amanda Liu",
    "UMD Website Team",
    "Software Engineer; Client Outreach",
    "Amanda_Liu.jpg",
  ],
  ...
  element[3] === ""
    ? [element[0], element[1], element[2], "unknown.png"]
    : element
);
...
const images = importAll(
  require.context("./memberpics", false, /\.(png|PNG|JPG|jpe?g|svg)$/)
);
    ...
    return (
      ...
      >
        <div style={{ marginBottom: "3em", color: "white" }}>
          ...
          <p style={{ marginLeft: "5em", marginRight: "5em" }}>
            Hack4Impact-UMD is a group of University of Maryland students who
            work with local and national non-profits to create software that
            improves the world around us. We also dicuss ethical technology,
            have talks about using technology for social good, and have fun!
            This club was founded in 2020 and is a chapter of the Hack4Impact, a
          ...
          <div className={styles.membergrid}>
            {allMembers.map((element) => (
              <div
                ...
                style={{ backgroundImage: `url(${images[element[3]]})` }}
              >
                <p>
                  <b>{element[0]}</b>
                  <br />
